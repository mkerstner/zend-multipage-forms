 ...
 */
class Custom_View_Helper_LinkRoute extends Zend_View_Helper_Abstract {
    ...
    public function getUrl($route, $full = false, $options = array(), $useClassicGetParams = false, $matchOptionsToRoute = false, $classicGetParams = null) {
        ...
        try {
            ...
            Model_Log::error('failed to calculate URL: ' . $e->getMessage());
            throw new Custom_Exception_IllegalArgumentException('Failed to calculate route-URL');
        }
    }
